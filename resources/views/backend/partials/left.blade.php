<div class="left">
    ...
    <div class="left__content">
        ...
        <div class="left__profile">
            <div class="left__image"><img src="{{asset('backend/assets/admin.png')}}" alt=""></div>
...
{{--            <li class="left__menuItem">--}}
{{--                <div class="left__title"><img src="{{asset('backend/assets/icon-edit.svg')}}" alt="">Hóa Đơn bán<img class="left__iconDown" src="{{asset('backend/assets/arrow-down.svg')}}" alt=""></div>--}}
{{--                <div class="left__text">--}}
{{--                    <a class="left__link" href="{{route('admin.import.create')}}">Thêm đơn bán</a>--}}
{{--                    <a class="left__link" href="{{route('admin.import.index')}}">Xem đơn bán</a>--}}
{{--                </div>--}}
{{--            </li>--}}
            <li class="left__menuItem">
